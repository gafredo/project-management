    ...
    <div className={sidebarClassNames}>
      <div className="flex h-[100%] w-full flex-col justify-start">
        ...
        <nav className="z-10 w-full">
          ...
          <SidebarLink icon={Users} label="Team" href="/teams"></SidebarLink>
        </nav>
...
const SidebarLink = ({ href, icon: Icon, label, color }: SidebarLinkProps) => {
  ...
  return (
    <Link href={href} className="w-full">
      ...
      >
        ...
        <Icon
          className={`h-6 w-6 text-gray-800 ${color ? color : "dark:text-gray-100"} `}
        />
        <span
          className={`font-medium text-gray-800 ${color ? color : "dark:text-gray-100"} `}
        >
          {label}
        </span>
      </div>
